...
if CheckPerk( ply ) == "leech" then
    ...
    --[[if (ply:Team() == 1) then
		ply:SetModel( "models/csgoleet4pm.mdl" )
	elseif (ply:Team() == 2) then
		ply:SetModel( "models/csgoswat1pm.mdl" )
	end]]
...
RegisterPerk( "Leech", "leech", 40, "Killing an enemy will restore 1/3 of your missing health, getting an assist will restore a % of 1/3 of your missing health. Auto-regenerate health after 3 seconds of not taking damage." )