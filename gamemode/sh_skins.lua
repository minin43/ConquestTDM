...
--//Not to be referenced by any files outside of sh_shop, use GM.WeaponSkins instead
GM.SkinsMasterTable = {
...
--//This references GAMEMODE.WeaponSkins and IT'S table structure, NOT ABOVE
