...
--[[Format: id = unique string of characters
            ...
            rare = rarity/unlock difficulty, 0 = none (black), 1 = uncommon (blue), 2 = rare (purple), 3 = legendary (gold)
...
GM.TitleMasterTable = {
    ...
    { id = "commfriend", title = "Community Friend", description = "Play on the server for 10 hours", rare = 1, req = 600, pdata = "g_time" },
    { id = "veteran", title = "The Veteran", description = "Play on the server for 20 hours", rare = 2, req = 1200, pdata = "g_time" },
    { id = "nolife", title = "The No-Life", description = "Play on the server for 50 hours", rare = 3, req = 6000, pdata = "g_time" },
    { id = "2fer", title = "The Two-fer", description = "Earn \"Double Kill\" (2 kill killspree) 30 times", rare = 0, req = 30 },
    { id = "3threat", title = "The Triple Threat", description = "Earn \"Multi Kill\" (3 kill killlspree) 20 times", rare = 1, req = 20 },
    { id = "4killer", title = "The Quad Killer", description = "Earn \"Mega Kill\" (4 kill killspree) 15 times", rare = 2, req = 15 },
    { id = "5up", title = "The Pent-Up", description = "Earn \"Ultra Kill\" (5 kill killspree) 10 times", rare = 3, req = 10 },
    { id = "thegod", title = "The God", description = "Earn \"Unreal\" (6 kill killspree) 10 times", rare = 3, req = 10 },
    ...
    { id = "topgun", title = "Top Gun", description = "Earn \"Top Gun\" (20 kill killstreak) 2 times", rare = 3, req = 2 },
    { id = "shaftmaster", title = "The Shaft Master", description = "Earn \"Shaft-Master\" (30 kill killstreak) 1 time", rare = 3, req = 1 },
    { id = "fastestdraw", title = "The Fastest Draw", description = "Earn \"First Blood\" (first kill of the match) 20 times", rare = 3, req = 20 },
    { id = "bsc", title = "Best Served Cold", description = "Earn \"Payback\" (kill your last killer) 20 times", rare = 0, req = 20 },
    ...
    { id = "headhunter", title = "Head Hunter", description = "Earn \"Head Hunter\" (kill an enemy over 100 m away with a bullet to the head) 20 times", rare = 1, req = 20 },
    { id = "bulletproof", title = "Bullet Proof", description = "Earn \"Low Life\" (getting a kill under 20 hp) 30 times", rare = 1, req = 30 },
    { id = "necromancer", title = "The Necromancer", description = "Earn \"Afterlife\" (getting a kill while dead) 10 times", rare = 2, req = 10 },
    ...
    { id = "bloodmoney", title = "Blood Money", description = "Earn \"Payback\" and \"Headshot\" in the same kill 5 times", rare = 2, req = 10 },
    ...
    { id = "elements", title = "The Elements", description = "Earn 2 kills with pryomancer's generated fire while the enemy is slowed by Frostbite", rare = 2, req = 2 },
    ...
    { id = "bhopasshole", title = "BHopping Asshole", description = "Get 10 kills while crouching in the air", rare = 1, req = 10 }    
...
for k, v in pairs( GM.WeaponsList ) do
    if GM.MasteryRequirements[ v.type ] then
        ...
        local newtitle = { id = v[ 2 ] .. "_attmastery", title = v[ 1 ] .. " Master", description = "Unlock all attachments for this weapon", rare = 0, req = 1 }
        GM.TitleMasterTable[ #GM.TitleMasterTable + 1 ] = newtitle
        newtitle = { id = v[ 2 ] .. "_mastery", title = v[ 1 ] .. " Expert", description = "Earn " .. req .. " kills with this weapon", rare = 0, req = req, pdata = v[ 2 ] }
        GM.TitleMasterTable[ #GM.TitleMasterTable + 1 ] = newtitle
    end
end
