...
GM.TitleMasterTable = {
    ...
    { id = "nolife", title = "The No-Life", description = "Play on the server for 50 hours (6,000 minutes)", rare = 4, req = 6000, pdata = "g_time" },
    ...
    { id = "5up", title = "Pent-Up", description = "Earn \"Ultra Kill\" (5 kill killspree) 5 times", rare = 3, req = 5 },
