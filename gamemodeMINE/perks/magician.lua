...
if CheckPerk( ply ) == "magician" then
    ...
    --[[if (ply:Team() == 1) then
		ply:SetModel( "models/csgopirate2pm.mdl" )
	elseif (ply:Team() == 2) then
		ply:SetModel( "models/csgofbi2pm.mdl" )
	end]]
...
RegisterPerk( "Magician", "magician", 20, "Increased reload speed and increased damage received, but receive a free revive every 5 minutes the class is used." )