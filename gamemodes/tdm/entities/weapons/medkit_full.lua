...
SWEP.PrintName = "Full Medkit"
--SWEP.Author = "robotboy655 & MaxOfS2D"
SWEP.Purpose = "Heals half your missing health, primary or secondary."
...
SWEP.RechargeInterval = 2 --//In seconds
...
function SWEP:Initialize()
	...
	timer.Create( "medkit_ammo" .. self:EntIndex(), self.RechargeInterval, 0, function()
...
function SWEP:PrimaryAttack()
	...
	local need = math.Clamp( ( ent:GetMaxHealth() - ent:Health() ) / 2, 0, 100 ) --//I guess I'm soft-locking this for people who have over 200 health
...
function SWEP:SecondaryAttack()
	...
	local need = math.min( math.Clamp( ( ent:GetMaxHealth() - ent:Health() ) / 2, 0, 100 ), self:Clip1() )
