...
flags[ "gm_lasertag" ] = {
    { "A", Vector( -485, 480.5, 192 ), 225.0, 0.0 }
}
...
flags[ "de_boston" ] = {
    { "A", Vector( 1273.875, -1873.0938, 272.0313 ), 220.0, 0.0 },
    { "B", Vector( 1739.375, -594.5938, 288.0313 ), 217.0, 0.0 },
    { "C", Vector( 74.3125, -1063.3438, 56.0313 ), 332.0, 0.0 },
    { "D", Vector( -1173.1875, -275.75, 64.0313 ), 252.0, 0.0 },
    { "E", Vector( -736.0625, 480.0938, 316.0313 ), 104.0, 0.0 }
}
...
flags[ "ttt_tarnish_v1" ] = {
    { "A", Vector( 2544.2813, -577.6875, 388.5 ), 187.0, 0.0 },
    { "B", Vector( 834.4063, -379.5938, 64.75 ), 254.0, 0.0 },
    { "C", Vector( 0.0313, -386.0938, -105.7188 ), 240.0, 0.0 }
}

flags[ "ttt_cod4_vacant" ] = {
    { "A", Vector( 831.9063, -459.3125, 48.0313 ), 279.0, 0.0 },
    { "B", Vector( -366.1875, -506.0313, 48.0313 ), 210.0, 0.0 },
    { "C", Vector( -1449.4063, 84.9688, 0 ), 233.0, 0.0 }
}

flags[ "de_halo_battlecreek" ] = {
    { "A", Vector( -4654.75, 2067, 1449.9063 ), 421.0, 0.0 }
}

flags[ "ttt_cwoffice2019_v3" ] = {
    { "A", Vector( 2513.8438, -1134.5625, -327.9688 ), 335.0, 0.0 },
    { "B", Vector( 2049.2813, 55.875, -151.9688 ), 200.0, 0.0 },
    { "C", Vector( 975.3438, 852, -151.9688 ), 228.0, 0.0 },
    { "D", Vector( 1570.0938, 513.6563, -495.9688 ), 266.0, 0.0 }
}

flags[ "ttt_heaven" ] = {
    { "A", Vector( 1592, 1743.3125, 8160.0313 ), 200.0, 0.0 },
    { "B", Vector( -255.2813, -255.9688, 8224.0313 ), 131.0, 0.0 },
    { "C", Vector( 2773.5313, -322.3125, 8064 ), 222.0, 0.0 },
    { "D", Vector( 2815.0938, -1599.4375, 7936.0313 ), 191.0, 0.0 },
    { "E", Vector( 3200.9688, -4127.8438, 8608.4375 ), 127.0, 0.0 }
}

flags[ "ttt_zeta" ] = {
    { "A", Vector( 1268.0313, -350.125, 0.0938 ), 256.0, 0.0 },
    { "B", Vector( 500.3125, 1048.0938, -31.9688 ), 191.0, 0.0 },
    { "C", Vector( 258.125, 2491.3438, -131.6563 ), 286.0, 0.0 }
}

flags[ "dm_canals" ] = {
    { "A", Vector( -2663.5625, -1024.2813, 144.0313 ), 303.0, 0.0 },
    { "B", Vector( -1278.9375, -1087.5, 400.0313 ), 250.0, 0.0 },
    { "C", Vector( -288.0938, -672.9688, 152.0313 ), 158.0, 0.0 }
}

flags[ "dm_powerhouse" ] = {
    { "A", Vector( -601.375, 442.8438, 32.0313 ), 143.0, 0.0 },
    { "B", Vector( -60.2188, -335.9063, 80.0313 ), 196.0, 0.0 },
    { "C", Vector( 445.5625, -2024.2813, 234.125 ), 191.0, 0.0 },
    { "D", Vector( -383.0938, -1514.3125, 480.0313 ), 152.0, 0.0 }
}

flags[ "dm_lockdown" ] = {
    { "A", Vector( -2554.6563, 4032, 128.0313 ), 197.0, 0.0 }
}

flags[ "dm_runoff" ] = {
    { "A", Vector( 11657.5625, 3345.6563, -498.5313 ), 466.0, 0.0 },
    { "B", Vector( 10288, 1984.6563, -255.9688 ), 354.0, 0.0 },
    { "C", Vector( 8708.9063, 1181.0313, -496.3438 ), 294.0, 0.0 }
}

flags[ "dm_steamlab" ] = {
    { "A", Vector( -2260.5313, 1453.5, 703.0313 ), 393.0, 0.0 },
    { "B", Vector( -2035.6563, 2056.8438, 1168.0313 ), 237.0, 0.0 },
    { "C", Vector( -2055.4688, 2736.2813, 824.0313 ), 192.0, 0.0 }
}

flags[ "dm_underpass" ] = {
    { "A", Vector( 219.5938, -1238.7813, 0 ), 156.0, 0.0 },
    { "B", Vector( -404.8125, -2023.75, 0 ), 215.0, 0.0 },
    { "C", Vector( -644.6875, -2095.3438, -515.9688 ), 140.0, 0.0 },
    { "D", Vector( 199.8438, -169.25, 160 ), 184.0, 0.0 }
}
...
local mapFlags = hook.Call( "LoadMapFlags", GM, game.GetMap() ) or flags[ game.GetMap() ]
...
if not mapFlags then return end
...
function SendFlagOrder( ply )
    --if !GAMEMODE.FlagsOrdered then
        ...
        for _, flagtable in pairs( mapFlags ) do
            if GetGlobalInt( "ConquestResupply", 0 ) != 0 then
