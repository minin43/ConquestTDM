--//This file is messy as shit, and contains a lot of code that isn't my own
...
local bombimage = Material( "vgui/bomb_icon_large.png" )
hook.Add( "HUDPaint", "HUD_CampfireBomb", function()
	if GAMEMODE.CampfireBomb and LocalPlayer():Alive() then
		...
		if GAMEMODE.CampfireBomb <= 10 then
			draw.SimpleTextOutlined( GAMEMODE.CampfireBomb, "CampfireBombFont", ScrW() - 110, ScrH() - 235, colorScheme[0]["GameTimerLow"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(255, 255, 255) )
		else
			draw.SimpleTextOutlined( GAMEMODE.CampfireBomb, "CampfireBombFont", ScrW() - 110, ScrH() - 235, Color( 0, 0, 0 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(255, 255, 255 ) )
		end
	end
end )
