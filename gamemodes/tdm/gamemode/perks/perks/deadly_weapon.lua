...
RegisterPerk("Deadly Weapon", "deadlyweapon", 0, "After reaching 4 kills in one life, equip a 1-shot-kill sniper with 1 bullet loaded. Earning a kill with it refreshes all weapon ammo and player heatlh.")
